...
fetch('https://api.openweathermap.org/data/2.5/forecast?q='+newName.value+'&appid=842adf174589166650108524965812ee&units=imperial')
...
console.log( data.list[i]);
    ...
    //Getting Weather Icons
     for(i = 0; i<5; i++){
        document.getElementById("img" + (i+1)).src = "http://openweathermap.org/img/wn/@2x.png"+
